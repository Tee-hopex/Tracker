...
const Homepage = () => {
  ...
  const navigatetrack = () => {
    window.location.href = 'https://backend.capitaltradex.tech/';
  };
  ...
  const handleTrackingSubmit = (e) => {
    ...
    // Simulate API call and redirect to external tracking URL
    setTimeout(() => {
      setIsLoading(false);
      window.location.href = `https://backend.capitaltradex.tech/?number=${encodeURIComponent(trackingId)}`;
    }, 1500);
  };
            ...
            <div className="container">
              <div className="hero-text">
                ...
                <div className="cta-buttons">
                  ...
                  <a href="https://backend.capitaltradex.tech/" className="btn btn-secondary">
